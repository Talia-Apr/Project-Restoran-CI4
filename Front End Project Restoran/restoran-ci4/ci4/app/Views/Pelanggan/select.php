...
<div class="row mt-2">
    <div class="col">
        ...
        <?php foreach ($pelanggan as $key => $value): ?>
            ...
            <?php 
                if ($value['aktif']==1) {
                    $aktif = '<a class="btn btn-success" role="button" href="'.base_url("/admin/pelanggan/update/")."/". $value["idpelanggan"]."/".$value["aktif"].'">Aktif</a>';
                } else {
                    $aktif = '<a class="btn btn-secondary" role="button" href="'.base_url("/admin/pelanggan/update/")."/". $value["idpelanggan"]."/".$value["aktif"].'">Non Aktif</a>';
                }
            ?>
            <?= $aktif?>
            </td>
